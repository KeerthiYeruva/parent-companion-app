...
import { bySelectedChildren, childSummary, monthlyCounts, thisWeekItems, todayItems } from "@/store/selectors";
import { useAppStore } from "@/store/use-app-store";

type ViewMode = "dashboard" | "week" | "month" | "tests" | "homework" | "activities";

const categoryGroup = ["Homework", "HomeStudy", "Activity", "ClassTest", "UnitTest", "Exam", "Project", "Circular"] as const;

export function DashboardView({ mode }: { mode: ViewMode }) {
