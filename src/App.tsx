  ...
  return (
    <AuthProvider onAuthUserChange={onAuthUserChange}>
      <AuthGate>
        <Routes>
          {/* Main planner */}
          <Route path="/" element={<PlanningView mode="day" showKidsTabs />} />

          <Route path="/week" element={<PlanningView mode="week" showKidsTabs />} />

          <Route path="/month" element={<PlanningView mode="month" showKidsTabs />} />
          ...
          <Route path="/kids/week" element={<Navigate to="/week" replace />} />
          <Route path="/kids/month" element={<Navigate to="/month" replace />} />
