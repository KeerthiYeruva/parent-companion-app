  ...
  return (
    <section className="document-import__scan-summary space-y-3">
      <div className="document-import__scan-summary-header rounded-xl border border-slate-200 bg-white p-4">
        <h2 className="document-import__scan-summary-title text-xl font-semibold text-slate-900">School Files</h2>
      ...
      <div className="document-import__scan-summary-cards grid gap-3 md:grid-cols-4">
        {cards.map((card) => (
          <article key={card.label} className="document-import__scan-summary-card rounded-xl border border-slate-200 bg-white p-4">
            <p className="document-import__scan-summary-card-label text-sm text-slate-600">{card.label}</p>
            <p className="document-import__scan-summary-card-value text-3xl font-bold text-slate-900">{card.value}</p>
          </article>
        ))}
      </div>
    </section>
